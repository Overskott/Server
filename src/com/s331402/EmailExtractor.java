...
public class EmailExtractor extends Thread {
    ...
    public void run() {
        ...
        try (
            ...
            } while (!urlInput.equalsIgnoreCase("exit"));

        } catch(MalformedURLException e){
            System.out.println("Wrong URL format " + e.getMessage());
